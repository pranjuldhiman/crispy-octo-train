...
class AdsAdapter(private val context: Context,bannerimg :List<Banners>) : PagerAdapter() {
    ...
    override fun instantiateItem(
      ...
      //  imageView.setImageResource(banner[position].bannerimage)
        Picasso.with(context).load("http://roundupclasses.com/assets/images/"+banner[position].bannerimage).placeholder(R.drawable.roundup_logo).error(R.drawable.roundup_logo).noFade().into(imageView);
